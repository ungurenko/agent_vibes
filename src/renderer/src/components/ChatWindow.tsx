      ...
      <AnimatePresence>
        {!isAtBottom && messages.length > 0 && (
          <motion.button
            ...
            className="absolute bottom-4 left-1/2 z-10 -translate-x-1/2 rounded-full border border-border bg-background p-2 shadow-lg transition-colors hover:bg-muted"
